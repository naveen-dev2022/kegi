class SearchAnyLocationModel {
  Result? result;
  String? status;
  String? error;

  SearchAnyLocationModel({ this.result, this.status});

  SearchAnyLocationModel.withError(String errorValue) : error = errorValue;

  SearchAnyLocationModel.fromJson(Map<String, dynamic> json) {
    result =
